...
describe("controller", function () {
  ...
  describe("routing", function () {
    ...
    it("should show completed entries", function () {
      // TODO: write test
      let todo = { title: "completed test todo" };
      setUpModel([todo]);
  ...
  it('should highlight "All" filter by default', function () {
    // TODO: write test
    setUpModel([{ id: 2454, title: "all todo", completed: false }]);
    subject.setView("#/all");
  ...
  it('should highlight "Active" filter when switching to active view', function () {
    // TODO: write test
    setUpModel([{ id: 42454, title: " active todo ", completed: false }]);
  ...
  describe("toggle all", function () {
    it("should toggle all todos to completed", function () {
      // TODO: write test
      setUpModel([{ id: 442454, title: " completed todo ", completed: true }]);
    ...
    it("should update the view", function () {
      // TODO: write test
      setUpModel([{ id: 42, title: " completed todo ", completed: false }]);
  ...
  describe("new todo", function () {
    it("should add a new todo to the model", function () {
      ...
      setUpModel([]);
      subject.setView("");
      view.trigger("newTodo", "a new todo to test");
  ...
  describe("element removal", function () {
    it("should remove an entry from the model", function () {
      // TODO: write test
      // // ????????????????????
      let todo = { id: 42, title: "my todo to renove", completed: true };
      setUpModel([todo]);
